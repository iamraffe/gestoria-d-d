...
@section('content')
    ...
    - Alta en hacienda IAE<br/>
    - Alta en el ROI (operadores intracomunitarios)<br/>
    - Preparación y cumplimentación de actas y certificaciones <br/>
    - Aplazamiento y fraccionamiento de deudas<br/>
    - Control Notificaciones electrónicas Hacienda<br/>
    - Disolución de Sociedades Liquidación de Sociedades<br/>
    - Ampliaciones y Reducciones de Capital <br/>
    - Certificados estar al corriente de pago<br/>
